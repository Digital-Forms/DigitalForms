                     ...
                     <div className="col-sm-12 col-md-12 col-lg-10 col-lg-offset-1 general_setting_hd">
                        <div className="col-xs-12 col-sm-12 col-md-12">
                           ...
                           <LinkContainer to="/">
                              ...
                              <button type="button" className="btn btn-primary pull-right plus_icon_table btn_plus_cusotm">+</button>
                              </a>
                           </LinkContainer>
                           <div className="clearfix"></div>
                           <div className="overflow_scroll_sm">
                              <table className="table table-bordered timecard_table custome_field_table">
                                 <thead>
                                    <tr>
                                       <th width="20%" align="center">Template Code</th>
                                       <th width="20%" align="center">Template Description</th>
                                       <th width="40%" align="center">Document</th>
                                       <th width="20%" align="center">&nbsp;</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    <tr>
                                       <td width="11%" align="center">FWINFO</td>
                                       <td align="center">Fairwork Aus Guide</td>
                                       <td align="center">1.24 Fair Work Information Statement.pdf</td>
                                       <td align="center">
